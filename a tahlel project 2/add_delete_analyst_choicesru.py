...
# Form implementation generated from reading ui file 'add_delete_analyst_choicesru.ui'
#
...
"")
        ...
        self.tableWidget.setGeometry(QtCore.QRect(13, 70, 611, 521))
...
"background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:0.687, y2:0.704545, stop:0.0646766 rgba(255, 155, 155, 255), stop:0.751244 rgba(235, 54, 30, 255));")
    ...
    def retranslateUi(self, Dialog):
        ...
        item.setText(_translate("Dialog", "التحليل"))
        item = self.tableWidget.horizontalHeaderItem(1)
        item.setText(_translate("Dialog", "التسلسل"))
